...
class ApiTest extends TestCase
{
    ...
    public function testShouldBeOkWhenSendSMS()
    {
        ...
        $sms = new SMS('+8860987654321', 'Hello, 世界');
        $actual = $client->sendSMS($sms);
    ...
    public function testShouldBeOkWhenGetDeliveryStatusBySMS()
    {
        ...
        $actual = $client->getDeliveryStatusBySMS('00000000-0000-0000-0000-000000000000', 1);
    ...
    public function testShouldBeOkWhenGetDeliveryStatusByMMS()
    {
        ...
        $actual = $client->getDeliveryStatusByMMS('00000000-0000-0000-0000-000000000000');
    ...
    public function testShouldBeOkWhenCancelSMS()
    {
        ...
        $actual = $client->cancelSMS('00000000-0000-0000-0000-000000000000');
    ...
    public function testShouldBeOkWhenCancelMMS()
    {
        ...
        $actual = $client->cancelMMS('00000000-0000-0000-0000-000000000000');
